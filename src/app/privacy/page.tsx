    ...
    <>
      <section className="bg-hero-gradient text-white py-24 px-4 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="font-heading text-5xl font-extrabold tracking-tight mb-4">Privacy Policy</h1>
      ...
      <SectionWrapper variant="white">
        <div className="max-w-3xl mx-auto prose prose-sm font-sans text-text">
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">1. Who We Are</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">2. Information We Collect</h2>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">3. How We Use Your Information</h2>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">4. We Do Not Sell Your Data</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">5. Third-Party Services</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">6. Data Retention</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">7. Your Rights</h2>
          <p>
          ...
          <h2 className="font-heading text-2xl font-extrabold tracking-tight text-navy mt-8 mb-3">8. Contact Us</h2>
          <p>
